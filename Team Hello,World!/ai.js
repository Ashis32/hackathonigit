...
function takeCommand(command) {
    if (command.includes("hello") || command.includes("hey")) {
        ...
        speak("I am bot, created by Team Hello world!. Tell me how can I help you ?");
    } else if (command.includes("how are you")) {
        speak("I am fine, how are you dear?");

   
    } else if (command.includes("i love u bot")) {
        speak("I Love you too");
    } else if (command.includes("tell me about igit")) {
        speak("ndira Gandhi Institute of Technology is one of the best colleges for technical education, known for its strong academic programs, excellent faculty, and great campus facilities.");
